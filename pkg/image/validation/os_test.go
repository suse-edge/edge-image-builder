	...
	tests := map[string]struct {
		...
		`all invalid config drive`: {
			...
			ExpectedFailedMessages: []string{
				...
				"The 'operatingSystem.isoConfiguration.installDevice' field is not valid for generating config drives.",
				"The 'operatingSystem.enableFIPS' field is not valid for generating config drives.",
				"The 'operatingSystem.packages.pkgList' field is not valid for generating config drives.",
				"The 'operatingSystem.packages.enableExtras' field is not valid for generating config drives.",
				"The 'operatingSystem.packages.regCode' field is not valid for generating config drives.",
				"The 'operatingSystem.packages.additionalRepos' field is not valid for generating config drives.",
				"The 'operatingSystem.packages.noGPGCheck' field is not valid for generating config drives.",
